...
public class myrefereeAdapter extends RecyclerView.Adapter<myrefereeAdapter.MyViewHolder> {
    private List<myrefereeModel> mDataset = new ArrayList<>() ;
    ...
    public myrefereeAdapter(List<myrefereeModel> myDataset, peopleClickListener peopleclicklistener) {
        mDataset = myDataset;
        this.peopleclicklistener = peopleclicklistener;
    }
    ...
    @Override
    public myrefereeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                     int viewType) {
        // create a new view
